...
if (!process.env.PORT) {
  throw new Error('PORT environment variable required');
}

const DATABASE_URL = process.env.MEMELLI_CORE_DATABASE_URL || process.env.DATABASE_URL;
if (!DATABASE_URL) {
  throw new Error('MEMELLI_CORE_DATABASE_URL or DATABASE_URL environment variable required');
}

const JWT_SECRET = process.env.JWT_SECRET || process.env.APP_SECRET;
if (!JWT_SECRET) {
  throw new Error('JWT_SECRET or APP_SECRET environment variable required');
}

const INTERNAL_TOKEN = process.env.INTERNAL_SERVICE_TOKEN;
if (!INTERNAL_TOKEN) {
  throw new Error('INTERNAL_SERVICE_TOKEN environment variable required');
}
